...
vim.keymap.set("n", "<leader>b", function() harpoon:list("cmd"):select(1) end)
vim.keymap.set("n", "<leader>n", function() harpoon:list("cmd"):select(2) end)
vim.keymap.set("n", "<leader>m", function() harpoon:list("cmd"):select(3) end)
